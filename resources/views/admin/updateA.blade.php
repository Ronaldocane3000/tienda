        ...
        <div class="col-md-12">
            <div class="card px-5 pb-5 pt-3">
                ...
                <div class="card-header">
                    <h4>Admin Profile
                        <a href="/dashboard" class="btn btn-primary btn-sm" style="float: right !important;">Back</a>
                    </h4>
                    
                </div>
                <form action="{{ url('update-profileA/'.Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
